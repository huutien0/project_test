    ...
    <div class="container">
        <div class="card">
            ...
            <form method="POST" action="{{ route('payment.checkout') }}">
                ...
                <div class="field">
                    <label for="family_name_kana">family_name_kana</label>
                    <input id="family_name_kana" name="family_name_kana" type="text" value="{{ old('family_name_kana') }}">
                </div>
                <div class="field">
                    <label for="given_name_kana">given_name_kana</label>
                    <input id="given_name_kana" name="given_name_kana" type="text" value="{{ old('given_name_kana') }}">
                </div>
                <div class="field">
                    <label for="customer_phone">Số điện thoại</label>
                    <input id="customer_phone" name="customer_phone" type="text" placeholder="+84123456789" value="{{ old('customer_phone') }}">
                </div>
                <div class="field">
                    <label for="description">Nội dung thanh toán</label>
                    <textarea id="description" name="description" rows="3">{{ old('description', 'Thanh toán dịch vụ') }}</textarea>
                </div>
                <div class="actions">
